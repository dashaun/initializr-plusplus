...
public class Dependencies {
    ...
    public static void removeFunctionStarters(Model model) {
        model.getDependencies().removeIf(d -> (d.getGroupId().equalsIgnoreCase(SPRING_CLOUD_GROUP_ID) && d.getArtifactId().equalsIgnoreCase(SPRING_CLOUD_FUNCTION_CONTEXT)));
        model.getDependencies().removeIf(d -> (d.getGroupId().equalsIgnoreCase(SPRING_CLOUD_GROUP_ID) && d.getArtifactId().equalsIgnoreCase(SPRING_CLOUD_FUNCTION_WEBFLUX)));
        model.getDependencies().removeIf(d -> (d.getGroupId().equalsIgnoreCase(SPRING_CLOUD_GROUP_ID) && d.getArtifactId().equalsIgnoreCase(SPRING_CLOUD_FUNCTION_AWS)));
    }
